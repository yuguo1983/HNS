...
Write-Host "  $GREEN  Denny Agent 安装成功！$RESET"
Write-Host "  $GREEN━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━$RESET"
Write-Host "`n  ${CYAN}安装位置:${RESET}  $INSTALL_DIR"
Write-Host "  ${CYAN}启动命令:${RESET}    denny"
Write-Host "`n  ${CYAN}常用命令:${RESET}"
Write-Host "    denny                    # 交互式聊天"
Write-Host "    denny -q \"你好\"          # 单次问答"
Write-Host "    denny swarm \"分析项目\"   # 多Agent协作"
Write-Host "    denny webui              # 启动 Web 界面"
Write-Host "`n  ${CYAN}升级:${RESET} irm https://raw.githubusercontent.com/yuguo1983/HNS/main/scripts/install.ps1 | iex"
Write-Host "  ${CYAN}卸载:${RESET} pip uninstall denny-agent; Remove-Item -Recurse $INSTALL_DIR"
Write-Host ""
